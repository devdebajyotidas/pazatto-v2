...
$(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
        ...
        dayClick: function(date, jsEvent, view) {
            ...
            selectedTicketDate = date;// new Date(date._d.getFullYear(), date._d.getMonth(), date._d.getDate());
            day =  date._d.getDate();
            month =  date._d.getMonth();
            year =  date._d.getYear();
            console.log((year + "/" + month + '/' + day),selectedTicketDate);
    ...
    $('#save-ticket').click(function () {
        console.log(selectedTicketDate);
        $('#calendar').fullCalendar('renderEvent',{
            title: $('#learning-module').val() + ' - ' + $('#ticket-name').val(),
            // start: new Date(year + "/" + month + '/' + day),
            start: selectedTicketDate,
            allDay : true
        });
